...
export function Permissions() {
    ...
    useEffect(() => {
        const fetchInstitutions = async () => {
            ...
            if (result.success) {
                ...
                const list: Institution[] = Array.isArray(instData) ? instData : instData?.data || [];
    ...
    return (
        <div className="space-y-6" dir={direction}>
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full" dir={direction}>
                <TabsList>
                ...
                <TabsContent value="institution" className="mt-6 space-y-4">
                    ...
                    {selectedInstitutionId ? (
                        ...
                        <div className="bg-white dark:bg-gray-800 py-12 rounded-lg border text-center">
